    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">categorie/id/edit</li>
            </ol>
        </nav>
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">modifier une cathegorie</h1>
            </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                          <form wire:submit.prevent="mount" action="#" method="POST">
                                  <div class="mb-4">
                                        <label for="categorie_noms">categorie de l'etablissement</label>
                                           <input type="text" class="form-control"  wire:model="state.categorie_noms"id="categorie_noms" aria-describedby="categorie_noms">
