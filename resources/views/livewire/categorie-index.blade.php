<div>
    <div>
        <div>
            ...
            <title>Toute les categories</title>
            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">categorie-index</li>
                    </ol>
                </nav>
                <h2 class="h4">Toute les categories</h2>
                <p class="mb-0"></p>
            </div>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">noms de la categorie</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="#" class="fw-bold"  render="row">{{ $categorie->id }}
                            </a>
                        </td>
                        <td>
                            <span class="fw-normal">{{$categorie->categorie_noms}}</span>
                        </td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu py-0">
                                    <a class="dropdown-item" href="{{ route('categorie-edit', $categorie->id) }}"> <span class="fas fa-edit me-2"></span>Edit</a>
